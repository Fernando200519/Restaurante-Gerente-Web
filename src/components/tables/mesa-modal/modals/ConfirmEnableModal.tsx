      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6 relative z-10 overflow-hidden transform transition-all scale-100">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-gray-500 text-sm mb-8 leading-relaxed px-2">
            ...
            pasará a estado <b>Disponible</b>.
            <br />
            Podrá recibir clientes y órdenes inmediatamente.
          </p>
          ...
          <div className="flex gap-3 w-full">
            ...
            <button
              onClick={onConfirm}
              disabled={loading}
              className="flex-1 py-3 px-4 rounded-xl bg-green-600 text-white font-semibold hover:bg-green-700 shadow-md hover:shadow-lg transition flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
            >
              {loading ? (
                <>
