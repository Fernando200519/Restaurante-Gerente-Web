...
export const ConfirmDisableModal: React.FC<Props> = ({
  nombre,
  loading,
  onCancel,
  onConfirm,
    ...
    <div className="fixed inset-0 z-70 flex items-center justify-center p-4">
      ...
      <div className="bg-white rounded-[2.5rem] shadow-2xl w-full max-w-sm p-8 relative z-10 animate-in zoom-in-95 duration-300 border border-white/20">
        ...
        <div className="flex flex-col items-center text-center">
          {/* 🌑 Icono de Advertencia / Desactivación */}
          <div className="w-16 h-16 bg-gray-50 rounded-3xl flex items-center justify-center mb-6 text-gray-400 shadow-sm border border-gray-100">
          ...
          <p className="text-gray-400 text-sm font-bold leading-relaxed mb-8 px-4">
            La unidad <span className="text-gray-900">"{nombre}"</span> quedará{" "}
            <span className="text-rose-500">Fuera de Servicio</span>. No podrá
            recibir nuevas comandas hasta su reactivación.
          </p>
          ...
          <div className="flex gap-4 w-full">
            ...
            <button
              onClick={onConfirm}
              disabled={loading}
              className={`${btnBase} bg-gray-800 text-white shadow-lg shadow-gray-200 hover:bg-gray-900`}
            >
              {loading ? (
                <>
